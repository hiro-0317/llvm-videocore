...
# %bb.0:
	...
	and	%r3, %r4                        # encoding: [0x00,0x47]
	st	%r3, 20 (%r0)                   # encoding: [0x00,0x00,0x00,0x00]
...
# %bb.0:
	...
	lea	%r0, _MergedGlobals(%pc)        # encoding: [0x00,0x00,0x00,0x00,0x00,0xe5]
