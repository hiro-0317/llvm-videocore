...
# %bb.0:
	...
	lea	%r1, crc_table(%pc)             # encoding: [0x00,0x00,0x00,0x00,0x00,0xe5,0x00,0x00]
...
BB0_1:                                  # =>This Inner Loop Header: Depth=1
	...
	and	%r4, %r2, 1                     # encoding: [0x01,0x00,0x00,0x00,0x00,0x1c,0x00,0x00]
	...
	and	%r3, %r5, 1                     # encoding: [0x01,0x00,0x00,0x00,0x00,0x1c,0x00,0x00]
	...
	and	%r3, %r4, 1                     # encoding: [0x01,0x00,0x00,0x00,0x00,0x1c,0x00,0x00]
	...
	cmp	%r2, 256                        # encoding: [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
...
# %bb.0:
	...
	nop                                     # encoding: [0x01,0x00]
	nop                                     # encoding: [0x01,0x00]
	j	BB1_3                           # encoding: [0x00,0x00,0x00,0x00,0x00,0xe0,0x00,0x00]
	nop                                     # encoding: [0x01,0x00]
	nop                                     # encoding: [0x01,0x00]
	nop                                     # encoding: [0x01,0x00]
# %bb.3:                                # %.preheader
	mov	%r3, 0                          # encoding: [0x00,0x00]
                                        # implicit-def: $r5
	j	BB1_4                           # encoding: [0x00,0x00,0x00,0x00,0x00,0xe0,0x00,0x00]
	lea	%r4, crc_table(%pc)             # encoding: [0x00,0x00,0x00,0x00,0x00,0xe5,0x00,0x00]
                                        #   fixup A - offset: 0, value: crc_table, kind: fixup_VideoCore4_32
	mov	%r2, -1                         # encoding: [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
	nop                                     # encoding: [0x01,0x00]
BB1_6:                                  #   in Loop: Header=BB1_4 Depth=1
	...
	and	%r8, %r9, 255                   # encoding: [0xff,0x00,0x00,0x00,0x00,0x1c,0x00,0x00]
...
BB1_4:                                  # =>This Inner Loop Header: Depth=1
	and	%r8, %r3, 3                     # encoding: [0x03,0x00,0x00,0x00,0x00,0x1c,0x00,0x00]
	cmp	%r8, 0                          # encoding: [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
...
# %bb.5:                                #   in Loop: Header=BB1_4 Depth=1
	mov	%r5, %r3                        # encoding: [0x00,0x00]
	add	%r5, %r0                        # encoding: [0x00,0x08]
	j	BB1_6                           # encoding: [0x00,0x00,0x00,0x00,0x00,0xe0,0x00,0x00]
...
# %bb.0:
	...
	lea	%r0, data(%pc)                  # encoding: [0x00,0x00,0x00,0x00,0x00,0xe5,0x00,0x00]
